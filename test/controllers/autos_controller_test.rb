...
class AutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auto" do
    assert_difference('Auto.count') do
      post autos_url, params: { auto: { modelo: @auto.modelo, name: @auto.name, photo: @auto.photo } }
    end
  ...
  test "should update auto" do
    patch auto_url(@auto), params: { auto: { modelo: @auto.modelo, name: @auto.name, photo: @auto.photo } }
